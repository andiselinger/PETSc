...
{
  PetscErrorCode ierr;
  const char     *algTypes[3] = {"scalable","nonscalable","new"};
  ...
  if (scall == MAT_INITIAL_MATRIX) {
    ...
    ierr = PetscOptionsEList("-matmatmult_via","Algorithmic approach","MatMatMult",algTypes,3,algTypes[1],&alg,NULL);CHKERRQ(ierr);
